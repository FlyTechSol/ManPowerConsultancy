...
namespace MC.Persistence.Repositories.Master
{
    public class HighestEducationRepository : GenericRepository<Domain.Entity.Master.HighestEducation>, IHighestEducationRepository
    {
        ...
        public async Task<PaginatedResponse<HighestEducationDetailDto>?> GetAllDetailsAsync(QueryParams queryParams, CancellationToken cancellationToken)
        {
            var query = _context.HighestEducations
                .AsNoTracking()
                .Where(q => !q.IsDeleted);
            ...
            return new PaginatedResponse<HighestEducationDetailDto>
            {
                Data = dtos,
