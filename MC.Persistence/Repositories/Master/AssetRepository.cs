...
namespace MC.Persistence.Repositories.Master
{
    public class AssetRepository : GenericRepository<Domain.Entity.Master.Asset>, IAssetRepository
    {
        ...
        public async Task<PaginatedResponse<AssetDetailDto>?> GetAllDetailsAsync(QueryParams queryParams, CancellationToken cancellationToken)
        {
            ...
            return new PaginatedResponse<AssetDetailDto>
            {
                Data = dtos,
