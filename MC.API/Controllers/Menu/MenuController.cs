...
namespace MC.API.Controllers.Menu
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<PaginatedResponse<MenuDto>>>> GetAll([FromQuery] QueryParams queryParams, CancellationToken cancellationToken)
        {
            var response = await _mediator.Send(new GetAllMenuQuery(queryParams), cancellationToken);
            return Ok(response);
        }
        ...
        public async Task<ActionResult> Post([FromBody] CreateMenuCmd request, CancellationToken cancellationToken)
        {
        ...
        public async Task<ActionResult> Put([FromBody] UpdateMenuCmd request, CancellationToken cancellationToken)
        {
