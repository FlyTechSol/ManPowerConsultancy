...
namespace MC.Application.Contracts.Persistence.Registration
{
    ...
    {
        Task<AddressDetailDto?> GetActiveAddressByUserIdAsync(string registrationId, CancellationToken cancellationToken);
        Task<List<AddressDetailDto>?> GetInactiveAddressByUserIdAsync(string registrationId, CancellationToken cancellationToken);
